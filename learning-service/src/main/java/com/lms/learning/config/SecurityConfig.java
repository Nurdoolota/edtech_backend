        ...
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/learning/tasks/*/submit")
                                .hasRole("STUDENT")
                        .requestMatchers(HttpMethod.POST, "/api/v1/learning/tasks/*/upload-audio")
                                .hasRole("STUDENT")
                        .requestMatchers(HttpMethod.GET, "/api/v1/learning/my-results")
                                .hasRole("STUDENT")
                        .requestMatchers(HttpMethod.GET, "/api/v1/learning/student/**")
                                .hasRole("STUDENT")
                        .requestMatchers(HttpMethod.GET, "/api/v1/learning/media/**")
